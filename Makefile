...
#
GXEMUL_NOSEFLAGS=-A "not llsc and not cache and not bev1 and not trapi and not counterdev and not watch and not capabilities and not cheri and not nofloat and not smalltlb and not bigtlb"
