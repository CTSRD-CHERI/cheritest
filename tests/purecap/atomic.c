...
#endif
// We are building baremetal (even though we are using the cheri-unknown-freebsd target)
#undef __FreeBSD__
...
////////////////////////////////////////////////////////////////////////////////
#if defined(__SIZEOF_INT128__) && !defined(__CHERI__)
...
#ifdef __CHERI__
// Not lockfree to avoid recursion (and in the future the compiler will no longer need this)
ATOMIC_RMW(cap, 0, __uintcap_t, add, +)
ATOMIC_RMW(cap, 0, __uintcap_t, sub, +)
// TODO: do we also want to support and/or/xor?
#endif
