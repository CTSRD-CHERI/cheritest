...
#define printf(...) __writeString(__VA_ARGS__)
...
void structassign (register Rec_Pointer d, register Rec_Pointer s);
...
__attribute__ ((constructor)) int dhrystone ()
/*****/
