...
#
# Test clearregs of lo16 general purpose registers
#
...
class test_cp2_clearregs_gplo(BaseBERITestCase):
    @attr('capabilities')
    def test_gp(self):
        ...
        for reg in range(32):
            ...
            if reg in special_gp_regs:
                ...
                self.assertRegisterEqual(regval, 0, "reg $%d was not cleared" % reg)
            else:
