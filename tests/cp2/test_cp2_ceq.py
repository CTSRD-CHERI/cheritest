...
class test_cp2_ceq(BaseBERITestCase):
    ...
    def test_cp2_ceq_offsets_diff(self):
        ...
        self.assertRegisterEqual(self.MIPS.a3, construct_answer(0,0,0,0,0,0), "Capabilities with different offsets compared incorrectly")
        
    @attr('capabilities')
    def test_cp2_ceq_base_and_offset_diff_sum_different(self):
        '''Compare capabilities with different base and offset, base+offset not equal'''
        self.assertRegisterEqual(self.MIPS.a4, construct_answer(0,0,0,0,0,0), "Capabilities with different base and offsets compared incorrectly")
