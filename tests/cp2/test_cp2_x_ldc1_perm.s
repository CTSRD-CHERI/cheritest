...
BEGIN_TEST
		...
		dli     $t0, ~CHERI_PERM_LOAD # Permit_Load not granted
		candperm $c1, $c2, $t0
		csetdefault $c1

		mtc1	$zero, $f1
		dla	$t1, data
		# This should raise a C2E exception since $ddc doesn't have PERMIT_LOAD
		check_instruction_traps $s0, ldc1 $f1, 0($t1)
		mfc1	$a0, $f1
