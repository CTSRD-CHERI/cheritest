...
class test_cp2_x_cgetperm_reg(BaseBERITestCase):
    ...
    def test_value(self):
        if self.MIPS.CHERI_C27_TO_31_INACESSIBLE:
            ...
            assert self.MIPS.a0 == self.max_permissions, "c27-c31 are no longer special - " + self.instruction + " should succeed"
            assert self.MIPS.a0 == self.MIPS.c27.perms, "c27-c31 are no longer special - " + self.instruction + " should succeed"
