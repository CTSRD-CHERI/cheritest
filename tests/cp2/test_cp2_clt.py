...
class test_cp2_clt(BaseBERITestCase):
    ...
    def test_cp2_clt_bases_diff(self):
        ...
        # B: base=0x42, offset=0x54
        self.assertRegisterEqual(self.MIPS.a2, construct_answer(1,0,0,0,0,0), "Capabilities with different bases compared incorrectly")
    ...
    def test_cp2_clt_base_and_offset_diff_sum_equal(self):
        ...
        # B: base=0x42, offset=0x54
        self.assertRegisterEqual(self.MIPS.a5, construct_answer(0,0,0,0,1,0), "Capabilities with equivalent base + offset compared incorrectly")
