...
class test_cp2_clt(BaseBERITestCase):
    @attr('capabilities')
    def test_cp2_clt_duplicated(self):
    ...
    @attr('capabilities')
    def test_cp2_clt_diff_offsets(self):
    ...
    @attr('capabilities')
    def test_cp2_clt_diff_bases(self):
    ...
    @attr('capabilities')
    def test_cp2_clt_both_null(self):
    ...
    @attr('capabilities')
    def test_cp2_clt_same_base_plus_offset(self):
    ...
    @attr('capabilities')
    def test_cp2_clt_one_null(self):
