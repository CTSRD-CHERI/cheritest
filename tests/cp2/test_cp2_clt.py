...
class test_cp2_clt(BaseBERITestCase):
    ...
    def test_cp2_clt_bases_diff(self):
        ...
        # B: base=0x42, offset=0x54
        self.assertRegisterEqual(self.MIPS.a2, construct_answer(1,0,1,0,0,0), "Capabilities with different bases compared incorrectly")

    @attr('capabilities')
    def test_cp2_clt_offsets_diff(self):
    ...
    @attr('capabilities')
    def test_cp2_clt_base_and_offset_diff_sum_different(self):
    ...
    @attr('capabilities')
    def test_cp2_clt_base_and_offset_diff_sum_equal(self):
        '''Test capabilities with complimentary bases and offsets'''
        # A: base=0x8000000000000053, offset=0x8000000000000001
        # B: base=0x42, offset=0x54
        self.assertRegisterEqual(self.MIPS.a5, construct_answer(0,0,1,0,1,0), "Capabilities with equivalent base + offset compared incorrectly")
