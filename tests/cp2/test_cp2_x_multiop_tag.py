...
class test_cp2_x_multiop_tag(BaseBERITestCase):
    ...
    def test_cp2_x_multiop_tag_2(self):
        self.assertRegisterEqual(self.MIPS.a2, 25, "An unexpected number of exceptions was raised during the test of capability operations on a register with tag bit clear")
