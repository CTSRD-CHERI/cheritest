...
.include "macros.s"
#
# Test that an exception does not set EPCC if CP0.Status.EXL is true
# (i.e. it's an exception within an exception handler). Derived from
# test_exception_exl
#
...
BEGIN_TEST
                ...
                #
                # Set EPC and EPCC to something recognizable
                #
