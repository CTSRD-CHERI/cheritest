...
class test_cp2_getcleartag(BaseCHERITestCase):
    @attr('capabilities')
    def test_cp2_getcleartag1(self):
        '''Test that cgettag returns correct initial value'''
        self.assertRegisterEqual(self.MIPS.a0, 1, "cgettag returns incorrect initial value")

    @attr('capabilities')
    def test_cp2_getcleartag2(self):
        '''Test that cgettag returns correct value after ccleartag'''
        self.assertRegisterEqual(self.MIPS.a1, 0, "cgettag returns incorrect value after ccleartag")
