...
class test_cp2_cle(BaseBERITestCase):
    ...
    def test_cp2_cle_bases_diff(self):
        ...
        # B: base=0x42, offset=0x54
        self.assertRegisterEqual(self.MIPS.a2, construct_answer(1,0,1,0,1,1), "Capabilities with different bases compared incorrectly")
    ...
    def test_cp2_cle_offsets_diff(self):
        ...
        # B: base=0x42, offset=0x54
        self.assertRegisterEqual(self.MIPS.a3, construct_answer(1,0,1,0,1,0), "Capabilities with different offsets compared incorrectly")
    ...
    def test_cp2_cle_base_and_offset_diff_sum_different(self):
        ...
        # B: base=0x42, offset=0x54
        self.assertRegisterEqual(self.MIPS.a4, construct_answer(1,0,1,0,1,0), "Capabilities with different base and offsets compared incorrectly")
    ...
    def test_cp2_cle_base_and_offset_diff_sum_equal(self):
        ...
        # B: base=0x42, offset=0x54
        self.assertRegisterEqual(self.MIPS.a5, construct_answer(1,1,1,0,1,0), "Capabilities with equivalent base + offset compared incorrectly")
