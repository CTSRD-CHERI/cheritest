...
class test_cp2_cllw_span(BaseBERITestCase):
	...
	self.assertRegisterEqual(self.MIPS.a4, 1, "Uninterrupted cllw+cld+cscw failed")
	...
	self.assertRegisterEqual(self.MIPS.a3, 0, "Interrupted cllw+csw+cscw succeeded")
