...
#
# Test that clbu raises a C2E exception if the offset is outside the
# range of the capability.
#

class test_cp2_x_clbu_perm(BaseCHERITestCase):
    @attr('capabilities')
    def test_cp2_x_clbu_perm_1(self):
        '''Test clbu did not read without Permit_Load permission'''
        self.assertRegisterEqual(self.MIPS.a0, 0,
            "clbu read without Permit_Load permission")

    @attr('capabilities')
    def test_cp2_x_clbu_perm_2(self):
