...
class test_cp2_cloadtags_unpriv(BaseBERITestCase):

    @attr('capabilities')
    @attr('cap256')
    def test_cp2_cloadtags_unpriv_256(self):
    ...
    @attr('capabilities')
    @attr('cap128')
    def test_cp2_cloadtags_unpriv_128(self):
        self.assertRegisterEqual(self.MIPS.a0, 0x00000000, "CLoadTags initial pattern")
        self.assertRegisterEqual(self.MIPS.a1, 0x000000A5, "CLoadTags updated pattern")

    @attr('capabilities')
    @attr('cap64')
    def test_cp2_cloadtags_unpriv_64(self):
        self.assertRegisterEqual(self.MIPS.a0, 0x00000000, "CLoadTags initial pattern")
