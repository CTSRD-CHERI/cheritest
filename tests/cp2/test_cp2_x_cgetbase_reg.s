...
#
# Test that cgetbase no longer raises an exception if th ecapability register is
# one of the previously reserved registers and the corresponding bit in PCC.perms is
# not set.
#
...
sandbox:
		...
		#
		dli     $a0, 1
		cgetbase $a0, $c27	# This should raise a C2E exception
