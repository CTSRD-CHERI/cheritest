...
class test_cp2_x_csb_perm(BaseBERITestCase):
    ...
    def test_cp2_x_csb_perm_1(self):
        ...
        self.assertRegisterEqual(self.MIPS.a0, 0x01,
            "csb wrote without Permit_Store permission")

    @attr('capabilities')
    def test_cp2_x_csb_perm_2(self):
        '''Test csb raises an exception when doesn't have Permit_Store permission'''
        self.assertRegisterEqual(self.MIPS.a2, 1,
            "csb did not raise an exception when didn't have Permit_Store permission")

    @attr('capabilities')
    def test_cp2_x_csb_perm_3(self):
        '''Test capability cause is set correctly when doesn't have Permit_Store permission'''
        self.assertRegisterEqual(self.MIPS.a3, 0x1301,
