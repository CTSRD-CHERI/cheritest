...
#
# Test that csetlen raises an exception if tag bit is not set on the capability
...
test:		.ent test
		...
		#
		# Clear the tag bit of $c1.
		ccleartag $c1, $c1

		dli	$t1, 2
		csetlen $c1, $c1, $t1 # This should raise a C2E exception
