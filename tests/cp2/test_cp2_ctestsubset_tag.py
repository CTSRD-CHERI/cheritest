...
class test_cp2_ctestsubset_tag(BaseBERITestCase):

    @attr('capabilities')
    def test_cp2_ctestsubset_tag_1(self):
        self.assertRegisterEqual(self.MIPS.a0, 0, "CTestSubset returned true when tags were different")

    @attr('capabilities')
    def test_cp2_ctestsubset_tag_2(self):
        self.assertRegisterEqual(self.MIPS.a1, 0, "CTestSubset returned true when tags were different")
