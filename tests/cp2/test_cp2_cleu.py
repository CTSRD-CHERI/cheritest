...
class test_cp2_cleu(BaseBERITestCase):
    ...
    def test_cp2_cleu_bases_diff(self):
        '''Compare LEU capabilities with different bases, offsets equal'''
    ...
    def test_cp2_cleu_offsets_diff(self):
        '''Compare LEU capabilities with different offsets, bases equal'''
    ...
    def test_cp2_cleu_base_and_offset_diff_sum_different(self):
        '''Compare LEU capabilities with different base and offset, base+offset not equal'''
