...
class test_cp2_x_cbtu_reg(BaseCHERITestCase):

    @attr('capabilities')
    def test_cp2_x_cbtu_reg_1(self):
        '''Test cbtu raised a C2E exception when register was reserved'''
        self.assertRegisterEqual(self.MIPS.a2, 1,
            "cbtu did not raise an exception when register was reserved")

    @attr('capabilities')
    def test_cp2_x_cbtu_reg_2(self):
