...
test:		.ent test
		...
		# by the next instruction: $c1 does not have Permit_Seal
		# permission, and also $c1 isn't executable. The specification
		# says that the exception due to lacking Permit_Seal has higher
		# priority.
		csealcode $c1, $c1
