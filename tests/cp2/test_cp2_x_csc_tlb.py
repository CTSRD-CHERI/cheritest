...
class test_cp2_x_csc_tlb(BaseBERITestCase):
    ...
    def test_cp2_clc_tlb_cause(self):
        ...
        self.assertRegisterEqual((self.MIPS.a7 >> 2) & 0x1f, 18, "CP0.Cause.ExcCode was not set correctly when capability store failed due to capability store inhibited in the TLB entry")
