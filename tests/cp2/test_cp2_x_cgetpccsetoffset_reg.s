...
#
# Test that cgetpccsetoffset raises an exception if the capability register is
...
sandbox:
		...
		#
		# This should raise a C2E exception
		dli $t0, 0x123  # offset
		cgetpccsetoffset  $c27, $t0
...
BEGIN_TEST
		...
		cgetoffset	$a0, $c27	# Should be 0x123
		cgetlen		$a1, $c27	# Should be max_len
