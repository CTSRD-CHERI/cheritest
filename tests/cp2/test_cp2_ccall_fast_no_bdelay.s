...
# CCallFast used to have a branch delay slot. Check that it no longer has one
...
BEGIN_TEST
	...
	cgetdefault	$c4
	ccall		$c1, $c2, 1
	cgetnull	$c4	# should not be executed
...
END_TEST
        ...
        .ent sandbox
sandbox:
	dli	$a1, 0x0de1a1	# zero-delay magic number
	CFromInt	$c5, $a1	# Check this to ensure the sandbox ran
	cjr	$c3
	nop
.end sandbox
