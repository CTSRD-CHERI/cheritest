...
class test_raw_fpu_add_inf_single(BaseBERITestCase):
    ...
    def test_raw_fpu_add_inf_single_2(self):
        ...
        self.assertRegisterMaskEqual(self.MIPS.a1, 0x7f800000, 0x7f800000, "add.s of +infinity and -infinity did not give NaN")
