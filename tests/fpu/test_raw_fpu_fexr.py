...
class test_raw_fpu_fexr(BaseBERITestCase):
    ...
    def test_raw_fpu_fexr_2(self):
        '''Test we can set FEXR to all zeros'''
        self.assertRegisterEqual(self.MIPS.a1, 0, "FEXR was not set to all zeros")
    ...
    def test_raw_fpu_fexr_4(self):
        '''Test we can set FEXR to all zeros by writing FCSR'''
        self.assertRegisterEqual(self.MIPS.a3, 0, "FEXR was not set to all zeros")
