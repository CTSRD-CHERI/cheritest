...
class test_ddiv_zero(BaseBERITestCase):

    def test_ddiv_zero_1(self):
        '''Test that teq after ddiv by zero raises an exception'''
        self.assertRegisterEqual(self.MIPS.a2, 1, "Test for division by zero faiiled to raise an exception")

    def test_ddiv_zero_2(self):
        '''Test that teq after ddiv set CP0.Cause.ExcCode to trap exception'''
