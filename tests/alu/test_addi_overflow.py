...
class test_addi_overflow(BaseCHERITestCase):
    def test_epc(self):
        self.assertRegisterEqual(self.MIPS.a0, self.MIPS.a5, "Unexpected EPC")

    def test_returned(self):
        self.assertRegisterEqual(self.MIPS.a1, 1, "flow broken by addi instruction")

    def test_handled(self):
        self.assertRegisterEqual(self.MIPS.a2, 1, "addi exception handler not run")
    ...
    def test_result_not_written(self):
        self.assertRegisterEqual(self.MIPS.t0, 0x7fffffff, "Result register should not be written on exception.")
