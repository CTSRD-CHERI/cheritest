...
#
# Overflow dsub, firing an arithmetic exception handler with slightly
# special case of subtracting maximally negative integer from itself.
# Although this doesn't sound like an overflow gxemul thinks it is and
# after consideration of the spec it probably is.
#
