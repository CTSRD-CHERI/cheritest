...
class test_cp0_reg_init(BaseBERITestCase):
    ...
    def test_config1_reg_nofloat(self):
        ...
        self.assertRegisterEqual(self.MIPS.a7, self.mkConfig1(1,16-1,3,4,0,1,6,0,1,0,0,1,0,0,0), "Unexpected CP0 config1 register value on reset")
    ...
    def test_config1_reg_float(self):
        '''Test initial value of CP0.config1'''
        self.assertRegisterEqual(self.MIPS.a7, self.mkConfig1(1,16-1,3,4,0,1,6,0,1,0,0,1,0,0,1), "Unexpected CP0 config1 register value on reset")
