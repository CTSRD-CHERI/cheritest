...
class test_tnei_lt_sign(BaseCHERITestCase):
    @attr('trapi')
    def test_epc(self):
    ...
    def test_returned(self):
        self.assertRegisterEqual(self.MIPS.a1, 1, "flow broken by tnei instruction")

    @attr('trapi')
    def test_handled(self):
        self.assertRegisterEqual(self.MIPS.a2, 1, "tnei exception handler not run")
