...
class test_tltiu_lt(BaseCHERITestCase):
    @attr('trapi')
    def test_epc(self):
    ...
    def test_returned(self):
        self.assertRegisterEqual(self.MIPS.a1, 1, "flow broken by tltiu instruction")

    @attr('trapi')
    def test_handled(self):
        self.assertRegisterEqual(self.MIPS.a2, 1, "tltiu exception handler not run")
