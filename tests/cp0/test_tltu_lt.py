...
class test_tltu_lt(BaseCHERITestCase):
    def test_epc(self):
        self.assertRegisterEqual(self.MIPS.a0, self.MIPS.a5, "Unexpected EPC")

    def test_returned(self):
        self.assertRegisterEqual(self.MIPS.a1, 1, "flow broken by tltu instruction")

    def test_handled(self):
        self.assertRegisterEqual(self.MIPS.a2, 1, "tltu exception handler not run")
