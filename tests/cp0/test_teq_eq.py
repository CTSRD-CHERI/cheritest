...
class test_teq_eq(BaseCHERITestCase):
    def test_teq_epc(self):
        self.assertRegisterEqual(self.MIPS.a0, self.MIPS.a5, "Unexpected EPC")

    def test_teq_returned(self):
