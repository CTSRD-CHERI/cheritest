...
class test_lw_unalign(BaseCHERITestCase):
    def test_epc(self):
        self.assertRegisterEqual(self.MIPS.a0, self.MIPS.a5, "Unexpected EPC")

    def test_returned(self):
        self.assertRegisterEqual(self.MIPS.a1, 1, "flow broken by lw instruction")

    def test_handled(self):
        self.assertRegisterEqual(self.MIPS.a2, 1, "lw exception handler not run")
