...
class test_cp0_lladdr(BaseBERITestCase):
    def test_llbit_not_supported(self):
        # 9.51 Configuration Register 5 (CP0 Register 16, Select 5), bit 4
        self.assertRegisterMaskEqual(self.MIPS.s7, 1 << 4, 0, msg="Expected LLBit to be unsupported")
